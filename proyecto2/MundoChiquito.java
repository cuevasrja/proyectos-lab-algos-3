...
public class MundoChiquito {
    ...
    */
    ...
    /**
    * Metodo que retorna las acciones validas para una solucion dada.
    * Complejidad O(1) ya que el metodo getVerticesConnectedTo() es O(1) y getAllVertices() es O(1) tambien.
    * @param grafo
    * @param sol
    * @return
    */
